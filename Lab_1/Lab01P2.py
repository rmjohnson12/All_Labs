...
# The user makes a choice and then indicates the number of times the computer should make a choice. The results of
# all games played are shown along with a summary of results.
#
